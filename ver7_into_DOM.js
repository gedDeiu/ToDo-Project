...
//We will get access to the display todos button;
var displayToDosButton = document.getElementById('displayToDosButton');
//We want to run the displayToDos method, when someone clicks the button;
displayToDosButton.addEventListener('click', function () {
  toDosList.displayToDos();
});

//We will get access to the toggle all button;
var toggleAllButton = document.getElementById('toggleAllButton');

//We want to run the toggleAll method, when someone clicks the button;
